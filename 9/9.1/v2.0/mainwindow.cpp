...
MainWindow::MainWindow(QWidget* parent) : QMainWindow(parent), 
                              ...
                              m_randStr(), m_trials(0), m_correctChars(0),
                                     m_totTrials(0), m_totCorrectChars(0),
                                      m_totOverallChars(0), m_totChars(0)  {
...
void MainWindow::on_startButton_clicked() {
    ...
    m_timer->setInterval(m_expInterval);
...
void MainWindow::on_nextButton_clicked() {
    ...
    int chars = m_randStr.getStringLenght();
    m_totChars += chars;
    m_totOverallChars += chars;
    m_correctChars += goodChars;
    m_totCorrectChars += goodChars;
    ui->correctCharFraction->setText(QString("%1 / %2").arg(m_correctChars).arg(m_totChars));
    ui->cumulativeFraction->setText(QString("%1 / %2").arg(m_totCorrectChars).arg(m_totOverallChars));
